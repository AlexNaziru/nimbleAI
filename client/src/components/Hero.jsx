    ...
    return (
        ...
        justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen">
            <div className="text-center mb-6">
                <h1 className="text-2xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold
                mx-auto leading-[1.2]">Create amazing content <br/> with <span className="text-primary">AI</span></h1>
                <p className="mt-4 max-w-sm sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-sm text-gray-600">
                    Transform your content creation with our suite of AI tools. Write articles, generate images and
                    enhance your work.</p>
            </div>
