...
import {HouseIcon, SquarePen, Hash, Image, Eraser, Scissors, FileTextIcon, Users, LogOut} from "lucide-react";
...
const Sidebar = ({sidebar, setSidebar}) => {
    ...
    return (
        ...
        top-14 bottom-0 ${sidebar ? 'tranlate-x-0' : 'max-sm:translate-x-full'} transition-all duration-300 ease-in-out`}>
            ...
            <div className="w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between">
                ...
                <LogOut onClick={singOut} className="w-4.5 text-gray-400 hover:text-gray700 transition cursor-pointer"/>
            </div>
        </div>
    )
}
